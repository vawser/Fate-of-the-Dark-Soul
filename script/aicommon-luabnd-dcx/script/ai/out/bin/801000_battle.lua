RegisterTableGoal(GOAL_Penetrator801000_Battle, "GOAL_Penetrator801000_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_Penetrator801000_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    elseif arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 180) then
        ...
        if 6.5 <= local3 then
            ...
            local0[22] = 0
            local0[23] = 0
            if not arg1:HasSpecialEffectId(TARGET_SELF, 10803) then
                local0[11] = 50
            end
    ...
    local1[1] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act01)
    local1[2] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act02)
    local1[3] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act03)
    local1[4] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act04)
    local1[5] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act05)
    local1[6] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act06)
    local1[7] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act07)
    local1[8] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act08)
    local1[9] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act09)
    local1[10] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act10)
    local1[11] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act11)
    local1[12] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act12)
    local1[20] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act20)
    local1[21] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act21)
    local1[22] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act22)
    local1[23] = REGIST_FUNC(arg1, arg2, Penetrator801000_Act23)
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, Penetrator801000_ActAfter_AdjustSpace), local2)
    return 
end

function Penetrator801000_Act01(arg0, arg1, arg2)
...
function Penetrator801000_Act02(arg0, arg1, arg2)
    Approach_Act_Flex(arg0, arg1, 4.2 - arg0:GetMapHitRadius(TARGET_SELF), 4.2 - arg0:GetMapHitRadius(TARGET_SELF) + 6, 4.2 - arg0:GetMapHitRadius(TARGET_SELF) + 6, 0, 0, 2, 4)
    local local0 = 3001
    local local1 = 3011
    local local2 = 3002
...
function Penetrator801000_Act03(arg0, arg1, arg2)
...
function Penetrator801000_Act04(arg0, arg1, arg2)
...
function Penetrator801000_Act05(arg0, arg1, arg2)
    local local0 = 3005
...
function Penetrator801000_Act06(arg0, arg1, arg2)
...
function Penetrator801000_Act07(arg0, arg1, arg2)
...
function Penetrator801000_Act08(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3014, TARGET_ENE_0, ATT_SUCCESSDIST, 0, 0, 0, 0)
    GetWellSpace_Odds = 100
    return GetWellSpace_Odds
end

function Penetrator801000_Act09(arg0, arg1, arg2)
    local local0 = 3016
    local local1 = ATT_SUCCESSDIST
    local local2 = 0
    local local3 = 0
...
function Penetrator801000_Act10(arg0, arg1, arg2)
    local local0 = 3017
    local local1 = ATT_SUCCESSDIST
    local local2 = 0
    local local3 = 0
...
function Penetrator801000_Act23(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_LeaveTarget, 1.8, TARGET_ENE_0, 2.5, TARGET_ENE_0, true, 9910)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function Penetrator801000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    return 
end
    ...
    elseif arg1:HasSpecialEffectId(TARGET_SELF, 5030) == false then
        if arg1:IsInterupt(INTERUPT_SuccessGuard) then
            if local0 < 6 and arg1:GetRandam_Int(1, 100) < 70 and 30 < arg1:GetSp(TARGET_SELF) then
                arg2:ClearSubGoal()
                Penetrator801000_Act02(arg1, arg2, paramTbl)
                return true
            end
