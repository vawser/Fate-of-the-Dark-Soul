RegisterTableGoal(GOAL_NPC_Pact_SunWarrior, "GOAL_NPC_Pact_SunWarrior")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_NPC_Pact_SunWarrior, true)
...
Goal.Activate = function (self, ai, goal)
    ...
    -- Act Distribution
    actChanceList[1] = 50 -- Light Attack
    actChanceList[2] = 20 -- Heavy Attack
    actChanceList[3] = 0 -- Kick
    actChanceList[4] = 0 -- Heavy Attack (Basic)
    actChanceList[5] = 10 -- Skill
    actChanceList[6] = 20 -- Running Attack
    actChanceList[7] = 0 -- Force
    actChanceList[8] = 30 -- Sunlight Spear
    ...
    -- Acts
    actFuncList[1] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act01) -- Light Attack
    actFuncList[2] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act02) -- Heavy Attack
    actFuncList[3] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act03) -- Kick
    actFuncList[4] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act04) -- Heavy Attack (Basic)
    actFuncList[5] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act05) -- Skill
    actFuncList[6] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act06) -- Running Attack
    actFuncList[7] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act07) -- Force
    actFuncList[8] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act08) -- Sunlight Spear
    
    actFuncList[10] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act10) -- Approach
    actFuncList[11] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act11) -- Retreat
    actFuncList[12] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act12) -- Strafe
    actFuncList[13] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act13) -- Forward Roll
    actFuncList[14] = REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_Act14) -- Backstep 
    
    Common_Battle_Activate(ai, goal, actChanceList, actFuncList, REGIST_FUNC(ai, goal, NPC_Pact_SunWarrior_ActAfter_AdjustSpace), actTblList)
    return 
end
...
function NPC_Pact_SunWarrior_Act01(self, ai, goal)
    -- Script
...
function NPC_Pact_SunWarrior_Act02(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Kick + Approach
function NPC_Pact_SunWarrior_Act03(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
function NPC_Pact_SunWarrior_Act04(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
    local distance = self:GetDist(TARGET_ENE_0)
...
-- Skill
function NPC_Pact_SunWarrior_Act05(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Running Attack
function NPC_Pact_SunWarrior_Act06(self, ai, goal)
    local roll_a = self:GetRandam_Int(1, 100)
    local roll_b = self:GetRandam_Int(1, 100)
...
-- Approach
function NPC_Pact_SunWarrior_Act10(self, ai, goal)
    if self:IsBothHandMode(TARGET_SELF) then
...
-- Retreat
function NPC_Pact_SunWarrior_Act11(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local duration = 1.8
    local animation = -1
...
-- Strafe
function NPC_Pact_SunWarrior_Act12(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
    local duration = 1.8
...
-- Forward Roll
function NPC_Pact_SunWarrior_Act13(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Backstep
function NPC_Pact_SunWarrior_Act14(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Force
function NPC_Pact_SunWarrior_Act07(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Sunlight Spear
function NPC_Pact_SunWarrior_Act08(self, ai, goal)
    local distance = self:GetDist(TARGET_ENE_0)
    local stamina = self:GetSp(TARGET_SELF)
...
-- Act After
-------------------------
function NPC_Pact_SunWarrior_ActAfter_AdjustSpace(self, ai, goal)
    return 
end
...
Goal.Interrupt = function (self, ai, goal)
    ...
    elseif ai:IsInterupt(INTERUPT_FindAttack) then
        goal:ClearSubGoal()
        if roll >= 75 then
            NPC_Pact_SunWarrior_Act12(ai, goal, paramTbl) -- Strafe
        else
            NPC_Pact_SunWarrior_Act13(ai, goal, paramTbl) -- Forward Roll
        end
    end
