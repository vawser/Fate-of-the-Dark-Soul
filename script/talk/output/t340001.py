...
def t340001_x1(gesture1=17, z1=9019, flag3=6067):
    """State 0,1"""
...
def t340001_x3(action1=10010713):
    """State 0,1"""
...
def t340001_x9():
    ...
    assert t340001_x1(gesture1=17, z1=9019, flag3=6067)
    ...
    while True:
        ...
        # Allot Estus
            ...
            assert (t340001_x21() and not (CheckSpecificPersonMenuIsOpen(8, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)))
            continue
        # Level up
...
def t340001_x21():
    ...
    if call.Get() == 1:
        ...
        if call.Get() == 1:
            ...
            assert t340001_x23(action1=13002014)
    elif call.Done():
        """State 2,8"""
        # action:13002013:"No <?gdsparam@150?> in inventory"
        assert t340001_x23(action1=13002013)
    """State 10"""
    return 0
    
def t340001_x22(offset=_):
    """State 0,1"""
