...
def t530000_x9():
    ...
    while True:
        ...
        # Allot Estus
            ...
            assert (t530000_x21() and not (CheckSpecificPersonMenuIsOpen(8, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0)))
            continue
        # Level up
...
def t530000_x21():
    ...
    if call.Get() == 1:
        ...
        if call.Get() == 1:
            ...
            assert t530000_x23(action1=13002014)
    elif call.Done():
        """State 2,8"""
        # action:13002013:"No <?gdsparam@150?> in inventory"
        assert t530000_x23(action1=13002013)
    """State 10"""
    return 0
    
def t530000_x22(offset=_):
    """State 0,1"""
