...
def t530003_x1(actionbutton1=6120, flag3=1015, flag4=6000, flag5=6000, flag6=6000, flag7=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t530003_x4(text2=12002600, z8=74000115, flag2=0, mode2=1):
    """State 0,5"""
...
def t530003_x5(z4=_, z5=_, z6=_, z7=_):
    """State 0,5"""
    assert t530003_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t530003_x6(text1=_, flag1=0, mode1=1):
    """State 0,4"""
    assert t530003_x3() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t530003_x18():
    ...
    if not GetEventStatus(74000115):
        """State 2,5"""
        # talk:12002600:" "
        assert t530003_x4(text2=12002600, z8=74000115, flag2=0, mode2=1)
    else:
        """State 3,6"""
        # talk:12002700:" "
...
def t530003_x26():
    ...
    while True:
        """State 5"""
        call = t530003_x1(actionbutton1=6120, flag3=1015, flag4=6000, flag5=6000, flag6=6000, flag7=6000)
        if call.Done():
            """State 3"""
