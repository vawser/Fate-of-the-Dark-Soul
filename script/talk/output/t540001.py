...
def t540001_x2(z1=_, z2=_, z3=_, z4=_):
    """State 0,5"""
...
def t540001_x12():
    ...
    while True:
        ...
        if GetEventStatus(25009680) == 1:
            ...
            call = t540001_x13(text1=88003000)
            if call.Done():
                pass
            elif IsPlayerDead() == 1:
                break
            ...
            call = t540001_x13(text1=88003010)
            if call.Done():
                pass
            elif IsPlayerDead() == 1:
                break
            ...
            call = t540001_x13(text1=88003020)
            if call.Done():
                pass
            elif IsPlayerDead() == 1:
                break
            ...
            call = t540001_x13(text1=88003030)
            if call.Done():
                pass
            elif IsPlayerDead() == 1:
                break
            ...
            call = t540001_x13(text1=88003040)
            if call.Done():
                pass
            elif IsPlayerDead() == 1:
                break
            ...
            call = t540001_x13(text1=88003050)
            if call.Done():
                pass
            elif IsPlayerDead() == 1:
                break
            ...
            call = t540001_x13(text1=88003060)
            if call.Done():
                pass
            elif IsPlayerDead() == 1:
                break
            ...
            break
    """State 1"""
    t540001_x13(text1=88002010)
    Quit()

def t540001_x13(text1=_):
    """State 0,2,3"""
    if GetDistanceToPlayer() < 9999:
        """State 4,7"""
        call = t540001_x3(text1=text1, flag1=0, mode1=1)
        if call.Done():
            pass
